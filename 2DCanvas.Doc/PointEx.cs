...
namespace dbarbee.GraphicsEngine._2DCanvas.Doc
{
    public static class PointEx
    {
        static PointEx()
        {
            //exDrawingObject.RegisterDrawMethod(typeof(PointEx).Name, new exDrawingObject.DrawObjectDelegate(Draw));
        }
        ...
        public static void Draw(IDrawingObject p, Canvas c)
        {
            c.DrawPoint(p as Point);
        }
